...
markOnlineOnConnect: true,
   ...
   if (pairingCode && !Yuta.authState.creds.registered) {
      ...
      setTimeout(async () => {
         ...
         console.log(chalk.black(chalk.bgGreen(`Selamat Datang Ke Script: Yuta-Botz By: LynnZxD`)))
...
"retailerId": `LynnZxD`,
"url": "wa.me/628999811229"
},
"businessOwnerJid": "15122377700@s.whatsapp.net",
"contextInfo": {isForwarded: true, mentionedJid: [num]}
},
}), { userJid: m.chat, quoted:  { key: { participant: '0@s.whatsapp.net', remoteJid: "0@s.whatsapp.net" }, message: { conversation: 'Welcome By Yuta Fungsi By LynnZxD' }}})    
